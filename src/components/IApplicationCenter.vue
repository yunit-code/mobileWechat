                                ...
                                <van-grid-item v-for="(item,index) in application_data" :key="item.key">
                                    <div @click="toApplication(item)" class="idm_applicationcenter_main_list">
                                        <div class="img_box">
                                            ...
                                            <div v-if="propData.showTodoNumber && item.showTodoNumber && item.todoNumber" class="number" :class="caculateApplicationNumber(item.todoNumber) ? 'number_small' : 'number_big'">{{ caculateApplicationNumber(item.todoNumber) ? item.todoNumber : '99+' }}</div>
                                        </div>
                ...
                if (this.propData.hasOwnProperty && this.propData.hasOwnProperty.call(this.propData, key)) {
                    ...
                    switch (key) {
                        ...
                        case "titleIconFontColor":
                            styleObjectTitleIcon["color"] = IDM.hex8ToRgbaString(element.hex8);
                            break
