    ...
    <div class="sys-login-box formbox loginForm">
        ...
        <van-form @submit="login">
          <van-field v-model="logname" :rules="[{ required: true }]" name="账号" placeholder="请输入账号" center>
            <template #left-icon>
                <van-icon name="manager" color="#2271b3" size="20" />
            </template>
          </van-field>
          <van-field class="idm-m-t" v-model="txtpassword" :rules="[{ required: true }]" type="password" name="密码" placeholder="请输入密码" center>
            <template #left-icon>
                <van-icon name="lock" color="#2271b3" size="20" />
            </template>
          </van-field>
